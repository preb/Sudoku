...
bool Sudoku::alreadyInRow(int num, int row) {
...
bool Sudoku::alreadyInCol(int num, int col) {
...
bool Sudoku::alreadyInBox(int num, int rowStart, int colStart) {
...
bool Sudoku::viable(int num, int row, int col) {
...
bool Sudoku::findNextEmptyCell(int &row, int &col) {
    for (row = 0; row < 9; ++row) {
        for (col = 0; col < 9; ++col)
